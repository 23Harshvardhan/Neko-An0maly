...
{
    public class StartProc : Command
    {
        public static string path = @"C:\ProgramData\";

        public StartProc(string name) : base(name) { }
        ...
        public override string execute(string[] args)
        {
            if (args.Length == 2)
            {
                ...
                {
                    Byte[] line1 = new UTF8Encoding(true).GetBytes("Start-Process -FilePath " + (char)34 + args[1] + (char)34 + " -Verb RunAs");
            ...
            else
            {
                ...
                Console.WriteLine("Invalid arguments for 'startproc'. Requires 2 argument(s).");
                Console.ForegroundColor = ConsoleColor.White;
                return "";
            }
        }
