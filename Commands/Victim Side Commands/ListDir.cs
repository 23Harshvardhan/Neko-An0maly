...
namespace Neko_An0maly.Commands
{
    public class ListDir : Command
    {
        ...
        public override string execute(string[] args)
        {
            if (args.Length == 2)
            {
                if (File.Exists(path + "dirlist.txt"))
                {
                    File.Delete(path + "dirlist.txt");
                }
            ...
            else
            {
                ...
                Console.WriteLine("Invalid arguments for 'listdir'.Requires 2 argument(s).");
        ...
        {
            string filetoDownload = "dirlist.txt";
        ...
        public static void check()
        {
            ...
            else
            {
                ...
                Console.ForegroundColor = ConsoleColor.White;
                string[] dirlist = File.ReadAllLines(path + "dirlist.txt");
